...
export POWERBLOCKADE_VERSION=0.7.6
...
- Update Recursor base image in `recursor/Dockerfile` and `recursor-reloader/Dockerfile` (both share the same upstream base).
